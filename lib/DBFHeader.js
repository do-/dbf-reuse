...
DBFHeader.from = async function (is, options = {}) {
	...
	let {encoder, lowerCaseFieldNames} = options; if (lowerCaseFieldNames !== false) lowerCaseFieldNames = true

	let tf = new DBFReader ({no_data: true, encoder, lowerCaseFieldNames})
